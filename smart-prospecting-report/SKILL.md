...
- `scripts/validate_project_timeline.py`: generation hard gate for investigation/reply/request/plan/report dates and photo watermark dates.
...
9. Run the timeline hard gate. If any date or photo-watermark conflict is found, stop and report the error to the user.
10. Generate the report and final QA outputs.
...
python /path/to/smart-prospecting-report/scripts/validate_project_timeline.py --form /path/to/smart-form.xlsx --project-dir /path/to/project-source --photos-dir /path/to/photos
```
...
- `references/timeline-validation.md`: mandatory timeline and photo-watermark stop rules.
